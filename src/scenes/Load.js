class Load extends Phaser.Scene {
    ...
    create() {
        // hero animations (walking) //All animations will be available in subsequent scenes
        this.anims.create({
            key: 'walk-down',
            frameRate: 8,
            repeat: -1,
        ...
        this.anims.create({
            key: "circular-attack",
            frameRate: 24,
            repeat: 0, //Animation will repeat 0 times
            frames: this.anims.generateFrameNumbers("hero", {
                frames: [16, 16, 16, 17, 18, 24, 25, 26, 21, 22, 30, 29, 28, 18, 19, 19, 19] //Array of sequence of frames to use
            })
        })
